...
def insert_mysql_data(sku_name, sku_really_price, sku_value):
    ...
    try:
        ...
        sku_id = myresult[0][0]
        mySql_insert_query = "INSERT INTO product_translations (product_id, locale, `name`, `description`) VALUES ('{}', '{}', '{}', '{}')".format(sku_id, 'en_US', sku_name, sku_name)
        cursor.execute(mySql_insert_query)
        connection.commit()
        mySql_insert_query = "INSERT INTO product_translations (product_id, locale, `name`, `description`) VALUES ('{}', '{}', '{}', '{}')".format(sku_id, 'ar', sku_name, sku_name)
        cursor.execute(mySql_insert_query)
        connection.commit()
